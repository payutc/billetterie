...
class PriceType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('isNominative', 'checkbox', array('label' => 'Tarif nominatif ou non ?', 'required' => false))
            ...
            ->add('isUniqueForUser', 'checkbox', array('label' => 'Unique ou non par acheteur ?', 'required' => false))
